...
//		sb.append(" */ \r\n");
		...
		sb.append("import org.spring.cloud.live.annotation.JsonParam;\r\n");
	...
	private void processAllMethod(StringBuffer sb,String bigTableName,String smallTableName,String describe) {
		...
		sb.append("	* @author " + Constant.AUTHORNAME + " " + GenUtil.getDate() + "\r\n");
		sb.append("	*/ \r\n");
		sb.append("	@ApiOperation(value = \"保存"+describe+"\",notes=\"保存"+describe+"\",response ="+bigTableName+"DTO.class)\r\n");
		...
		sb.append("		GwsLogger.info(\""+describe+"保存开始:code={},message={},"+smallTableName+"VO={}\",code,message,JSON.toJSONString("+smallTableName+"VO));\r\n");
		...
		sb.append("			   GwsLogger.info(\""+describe+"保存失败:code={},message={},"+smallTableName+"={}\",code,message,JSON.toJSONString("+smallTableName+"VO));\r\n");
		sb.append("			}\r\n");
		sb.append("		} catch (Exception e) {\r\n");	
		sb.append("			code = CommConstant.GWSCOD0001;\r\n");	
		sb.append("			message = CommConstant.GWSMSG0001;\r\n");
		sb.append("			GwsLogger.error(\""+describe+"保存异常:"+smallTableName+"VO={},e={}\",JSON.toJSONString("+smallTableName+"VO)"+",e);\r\n");
		sb.append("		}\r\n");	
		...
		sb.append("	@ApiImplicitParam(name =\"id\",value =\"主键id\",paramType=\"query\", required = true, dataType =\"Long\")\r\n");
		...
		sb.append("	* @author " + Constant.AUTHORNAME + " " + GenUtil.getDate() + "\r\n");
		sb.append("	*/ \r\n");
		sb.append("	@ApiOperation(value = \"根据id查询"+describe+"\",notes=\"根据id查询"+describe+"\",response ="+bigTableName+"DTO.class)\r\n");
		sb.append("	@ApiImplicitParam(name =\"id\",value =\"主键id\",paramType=\"query\", required = true, dataType =\"Long\")\r\n");
		sb.append("	@RequestMapping(value = \"/find"+bigTableName+"ById\",method =RequestMethod.GET)\r\n");
		sb.append("	public RetResult find"+bigTableName+"ById(Long id){\r\n");
		sb.append("		String code = CommConstant.GWSCOD0000;\r\n");
		sb.append("		String message = CommConstant.GWSMSG0000;\r\n");
		...
		sb.append("	* @author " + Constant.AUTHORNAME + " " + GenUtil.getDate() + "\r\n");
		sb.append("	*/ \r\n");
		sb.append("	@ApiOperation(value = \"查询所有"+describe+"\",notes=\"查询所有"+describe+"\",response ="+bigTableName+".class)\r\n");
		sb.append("	@ApiImplicitParams({\r\n");
		sb.append("		@ApiImplicitParam(name =\""+smallTableName+"VO\",value =\"详细实体"+smallTableName+"\",paramType=\"query\", required = true, dataType =\""+bigTableName+"\"),\r\n");
		sb.append("		@ApiImplicitParam(name =\"pageNo\",value =\"第几页\",paramType=\"query\", required = true, dataType =\"Long\"),\r\n");
		sb.append("		@ApiImplicitParam(name =\"pageSize\",value =\"每页条数\",paramType=\"query\", required = true, dataType =\"Long\")\r\n");
		sb.append("		})\r\n");
		...
		sb.append("		String code = CommConstant.GWSCOD0000;\r\n");
		sb.append("		String message = CommConstant.GWSMSG0000;\r\n");
		sb.append("		GwsLogger.info(\"查询所有"+describe+"开始:pageNo={},pageSize={},"+smallTableName+"\",pageNo,pageSize,JSON.toJSONString("+smallTableName+"));\r\n");
		sb.append("		//查询所有"+describe+"\r\n");
		...
		sb.append("			code = CommConstant.GWSCOD0001;\r\n");	
		sb.append("			message = CommConstant.GWSMSG0001;\r\n");
		sb.append("			GwsLogger.error(\"查询所有"+describe+"异常:code={},message={},"+smallTableName+"={},pageNo={},pageSize={},softField={},e={}\",code,message,JSON.toJSONString("+smallTableName+"),pageNo-1,pageSize,e);\r\n");
		sb.append("		}\r\n");	
		...
		sb.append("	* @author " + Constant.AUTHORNAME + " " + GenUtil.getDate() + "\r\n");
		sb.append("	*/ \r\n");
		sb.append("	@ApiOperation(value = \"修改"+describe+"\",notes=\"修改"+describe+"\",response ="+bigTableName+"DTO.class)\r\n");
		sb.append("	@ApiImplicitParam(name =\""+smallTableName+"VO\",value =\"详细实体"+smallTableName+"\",paramType=\"query\", required = true, dataType =\""+bigTableName+"\")\r\n");
		...
		sb.append("		String code = CommConstant.GWSCOD0000;\r\n");
		sb.append("		String message = CommConstant.GWSMSG0000;\r\n");
		sb.append("		GwsLogger.info(\"修改"+describe+"开始:"+smallTableName+"\",JSON.toJSONString("+smallTableName+"VO));\r\n");
		sb.append("		//修改"+describe+"\r\n");
		sb.append("		"+bigTableName+"DTO "+smallTableName+"DTO = null;\r\n");	
		sb.append("		try {\r\n");	
		sb.append("			"+bigTableName+" "+smallTableName+" = ("+bigTableName+") EntityDtoConverter.copy("+smallTableName+"VO);\r\n");
		...
		sb.append("			code = CommConstant.GWSCOD0001;\r\n");	
		sb.append("			message = CommConstant.GWSMSG0001;\r\n");
		sb.append("			GwsLogger.error(\"修改"+describe+"异常:code={},message={},"+smallTableName+"={},e={}\",code,message,JSON.toJSONString("+smallTableName+"VO),e);\r\n");
		sb.append("		}\r\n");	
