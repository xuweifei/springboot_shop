...
//		sb.append(" */ \r\n");
		...
		sb.append("import com.opengroup.longmao.gwcommon.enums.IsDeleteEnum;\r\n");
	...
	private void processAllMethod(StringBuffer sb,String bigTableName,String smallTableName,String describe) {
		...
		sb.append("		//query.setId("+smallTableName+".getId());\r\n");
		sb.append("		//query.setIsDelete(IsDeleteEnum.UN_DELETE.getVal());\r\n");
		sb.append("		//字段排序\r\n");
		...
		sb.append("		return "+smallTableName+"RepositorySlave.findOne(id);\r\n");
		sb.append("	}\r\n\r\n");
		...
		sb.append("		}else{\r\n");
		sb.append("			GwsLogger.error(\""+describe+"对象不存在，保存失败:"+smallTableName+"={}\",JSON.toJSONString("+smallTableName+"));\r\n");
		...
		sb.append("		if("+smallTableName+".getId()!=null&&"+smallTableName+".getId()>0){\r\n");
		sb.append("		    //先从库中查出该对象\r\n");
		...
		sb.append("			}else{\r\n");
		sb.append("			    GwsLogger.error(\""+describe+"对象不存在，修改失败:"+smallTableName+"={}\",JSON.toJSONString("+smallTableName+"));\r\n");
		sb.append("		        return null;\r\n");
		sb.append("			}\r\n");
		sb.append("		}else{\r\n");
		sb.append("			 GwsLogger.error(\""+describe+"id不存在，修改失败:"+smallTableName+"={}\",JSON.toJSONString("+smallTableName+"));\r\n");
		sb.append("		     return null;\r\n");
		sb.append("		}\r\n");
		sb.append("		return "+smallTableName+";\r\n");
		sb.append("	}\r\n\r\n");
